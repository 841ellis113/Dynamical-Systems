...
#of r. A negative value of the lyapunov exponent at r = r0 indicates that parameter is well
#behaved or non-chaotic. For positive exponents, this indicates that the particulr r value
...
#calculate the values of the logistical map with an initial x0 and parameter r, only capturing data
...
#the Lyapunov exponent becomes posititve and a chaos begins
